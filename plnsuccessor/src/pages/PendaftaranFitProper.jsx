...
const PendaftaranFitProper = () => {
    return (
        <div className="PendaftaranFitProper">
            ...
            <div className="Title">
                <p className="TitleUtama">Fit & Proper / <span>Pendaftaran Peserta Fit & Proper</span></p>
            ...
            <Button href="/fitproper/pendaftaranfitprope/editlistfitproper" className="ButtonEditPendaftaranFitProper" variant="outlined">
                <p>Edit List</p>
            </Button>
